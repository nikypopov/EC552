...
print(dictionary)
with open(os.path.join(os.getcwd(), 'input/sample.input.json'), "w") as outfile:
	outfile.write(json_object)

options = 'options.csv'
x_in = int(input_params[0])
...
for chassis in chassis_name:
	...
	if sum(operation_params) == 0:
		...
		input_sensor_file = 'sample.input.json'
